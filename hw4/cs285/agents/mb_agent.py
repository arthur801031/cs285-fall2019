...
class MBAgent:
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        for i in range(self.ensemble_size):
            ...
            observations = ob_no[start:finish] # DoneTODO(Q1)
            actions = ac_na[start:finish] # DoneTODO(Q1)
            next_observations = next_ob_no[start:finish] # DoneTODO(Q1)

            # use datapoints to update one of the dyn_models
            model = self.dyn_models[i] # DoneTODO(Q1)
